...
def allfiles():
    df_re = pd.DataFrame()
    file = ['/Users/xinyue/PycharmProjects/cic_peoject/merge_catalog/2007_catalog.csv', '/Users/xinyue/PycharmProjects/cic_peoject/merge_catalog/1997_catalog.csv', '/Users/xinyue/PycharmProjects/cic_peoject/merge_catalog/2002_catalog.csv']
    result_file = ['/Users/xinyue/PycharmProjects/cic_peoject/merge_catalog/2007_catalog_result.xlsx', '/Users/xinyue/PycharmProjects/cic_peoject/merge_catalog/1997_catalog_result.xlsx', '/Users/xinyue/PycharmProjects/cic_peoject/merge_catalog/2002_catalog_result.xlsx']
    for f,re in zip(file,result_file):
        year = f.split('/')[-1][:4]
        part = read_in(f, re, year)
        df_re = df_re.append(part)
    df_re.to_csv('/Users/xinyue/PycharmProjects/cic_peoject/merge_catalog/Result/Result.csv')
...
def read_in(file, result_file,year):
    ...
    col = ['index', 'output_file', 'content', 'sub_content', 'cic', 'CIC']
    final = final[col]
    final['Year'] = year
    return final
...
# 2007 1997
file = '/Users/xinyue/PycharmProjects/cic_peoject/merge_catalog/2002_catalog.csv'
result_file ='/Users/xinyue/PycharmProjects/cic_peoject/merge_catalog/2002_catalog_result.xlsx'
