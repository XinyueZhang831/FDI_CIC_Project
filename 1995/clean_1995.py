...
def read_in_file():
    catalog = pd.read_csv('/Users/xinyue/PycharmProjects/cic_peoject/1995/1995.csv')
    ...
    clean_catalog_number.to_csv('/Users/xinyue/PycharmProjects/cic_peoject/1995/1995_catalog.csv')
